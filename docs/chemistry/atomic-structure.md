本页对应 [普通高中教科书 化学 选择性必修2 物质结构与性质](https://book.pep.com.cn/1442001132201/mobile/index.html) 第 6-16 页部分内容。
...
4. **能级**：每一个能层中决定能量高低顺序的不同亚层。同一能层中，第 n 能层中的能级按能量由低至高分别用 $n\mathrm{s}$, $n\mathrm{p}$, $n\mathrm{d}$, $n\mathrm{f}$ 表示。例：$\mathrm{1s}$, $\mathrm{2p}$, $\mathrm{4d}$ 都是能级。
...
在基态原子中，电子排布优先按照使 **总体能量从小到大** 的方式填充各个能级。
